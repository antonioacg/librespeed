...
RUN sed -i 's#"/var/www/localhost/htdocs"#"/var/www/html"#g' /etc/apache2/httpd.conf && \
    ...
    echo 'PidFile /tmp/httpd.pid' > /etc/apache2/conf.d/pid.conf && \
    echo 'Mutex posixsem' > /etc/apache2/conf.d/mutex.conf && \
    mkdir -p /var/www/html /database && \
    chown -R apache:apache /var/www/html /speedtest /database
